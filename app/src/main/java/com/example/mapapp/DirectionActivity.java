...
public class DirectionActivity extends FragmentActivity implements OnMapReadyCallback, RoutingListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        latStart = getIntent().getDoubleExtra(MapHomeActivity.KEY_LAT_START, 0);
        lngStart = getIntent().getDoubleExtra(MapHomeActivity.KEY_LNG_START, 0);
        latEnd = getIntent().getDoubleExtra(MapHomeActivity.KEY_LAT_END, 0);
        lngEnd = getIntent().getDoubleExtra(MapHomeActivity.KEY_LNG_END, 0);
        ...
        Routing routing = new Routing.Builder()
                ...
                .key("AIzaSyAR2PpsDHW0Zg4l_oBG_zSxfDOi_ILw070")
                .waypoints(start, end)
                .withListener(this)
                .build();
        routing.execute();
