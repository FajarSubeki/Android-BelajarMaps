...
public class MapHomeActivity extends AppCompatActivity {
    ...
    void onBtnHitungClick() {
        ...
        intent.putExtra(MapHomeActivity.KEY_LAT_START, latStart);
        intent.putExtra(MapHomeActivity.KEY_LNG_START, lngStart);
        intent.putExtra(MapHomeActivity.KEY_LAT_END, latEnd);
        intent.putExtra(MapHomeActivity.KEY_LNG_END, lngEnd);
